...
Calibrator::Calibrator(JsonParams json_params)
{
    ...
    std::cout << "params_.N_FILE: " << params_.N_FILE << std::endl;
...
void Calibrator::Calibrate()
{
    ...
    // float rot_init = params_.search_range_rot + 0.05;
    // float trans_init = params_.search_range_trans + 0.005;
    float rot_init = params_.search_range_rot;
    float trans_init = params_.search_range_trans;
    do{
